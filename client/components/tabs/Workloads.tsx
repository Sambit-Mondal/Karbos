...
const Workloads = () => {
  ...
  return (
    <div className="space-y-6">
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-karbos-blue-purple">
              {jobs.map((job) => (
                <tr
                  key={job.id}
                  className="hover:bg-karbos-navy transition-colors cursor-pointer"
      ...
      {/* Job Details Drawer */}
      {selectedJob && (
        <div className="fixed inset-y-0 right-0 w-full md:w-1/2 lg:w-1/3 bg-karbos-navy border-l border-karbos-blue-purple shadow-xl transform transition-transform z-50 overflow-y-auto">
          <div className="p-6">
